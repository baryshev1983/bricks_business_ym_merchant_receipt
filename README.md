# Bricks.Business.YmMerchantReceipt

Пакет включает классы, описывающие параметры для формирования чека согласно 54-ФЗ с использование протокола Яндекс.деньги. Данные классы реализуют интерфейс, позволяющий сгенерировать JSON-строку на их основе.
...
[исходные коды]: https://github.com/Bashka/bricks_business_ym_merchant_receipt/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_business_ym_merchant_receipt/issues
